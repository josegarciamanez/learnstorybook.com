...
description: 'Una guía para las últimas herramientas preparadas para la producción de sistemas de diseño.'
---

<div class="aside">Esta guía está hecha para <b>desarrolladores profesionales</b> que estén aprendiendo cómo construir sistemas de diseño. Se recomienda tener experiencia intermedia en JavaScript, Git e integración continua. También se deben conocer los conceptos básicos de Storybook, como escribir una historia y editar archivos de configuración(<a href="/intro-to-storybook">Intro to Storybook</a> le enseñará lo básico).
</div>

<br/>

Los sistemas de diseño son cada vez más populares. Desde pesos pesados de tecnología como Airbnb a startups, todo tipo de empresas están reutilizando sus patrones de UI para ahorrar tiempo y dinero. Pero hay un abismo entre los sistemas de diseño creados por Airbnb, Uber, Microsoft y los sistemas de diseño creados por la mayoría de los desarrolladores.

¿Por qué los equipos de sistemas de diseño líderes utilizan las herramientas y las técnicas que usan? Mi coautor Tom y yo investigamos los rasgos de los sistemas de diseño exitosos de la comunidad de Storybook para identificar las mejores prácticas.

Esta guía paso a paso revela las herramientas automatizadas y los flujos de trabajo cuidadosos utilizados en los sistemas de diseño de producción a escala. Caminaremos a través de reunir un sistema de diseño de las bibliotecas de componentes existentes, luego configuraremos servicios, bibliotecas y los flujos de trabajo principales.
